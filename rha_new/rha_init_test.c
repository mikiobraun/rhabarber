...
object_t b_clone(tuple_t t) {
  return wrap(INT_T, clone(tuple_get(t, 1)));
}
object_t b_ptype(tuple_t t) {
  return wrap(INT_T, ptype(tuple_get(t, 1)));
}
...
object_t rha_init()
{
  ...
  add_function(module, clone_sym, INT_T, (void *) clone, 1, OBJECT_T);
  add_function(module, ptype_sym, INT_T, (void *) ptype, 1, OBJECT_T);
  add_function(module, lookup_sym, OBJECT_T, (void *) lookup, 2, OBJECT_T, SYMBOL_T);
  add_function(module, assign_sym, OBJECT_T, (void *) assign, 3, OBJECT_T, SYMBOL_T, OBJECT_T);
  add_function(module, rmslot_sym, VOID, (void *) rmslot, 2, OBJECT_T, SYMBOL_T);
  add_function(module, print_sym, VOID, (void *) print, 1, OBJECT_T);
  add_function(module, include_sym, VOID, (void *) include, 2, OBJECT_T, OBJECT_T);
  add_function(module, subscribe_sym, VOID, (void *) subscribe, 2, OBJECT_T, OBJECT_T);
  add_function(module, ls_sym, OBJECT_T, (void *) ls, 1, OBJECT_T);
  add_function(module, lsall_sym, OBJECT_T, (void *) lsall, 1, OBJECT_T);
  ADD_MODULE(eval);
  add_function(module, eval_sym, OBJECT_T, (void *) eval, 2, OBJECT_T, OBJECT_T);
