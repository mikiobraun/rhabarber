...
tuple_t resolve_infix_prule_list(any_t env, list_t parsetree, 
				 ...
				 symbol_t fun_sym, bool left_binding);
...
list_t split_by_semicolon(list_t parsetree)
{
  ...
  while (obj) {
    bool is_semicolon = is_symbol(semicolon_sym, obj);
...
tuple_t resolve_infix_prule(any_t env, list_t parsetree, symbol_t prule_sym, symbol_t fun_sym, bool left_binding)
{
  glist_t sym_list;
  glist_init(&sym_list);
...
tuple_t resolve_infix_prule_list(any_t env, list_t parsetree, glist_t *prule_sym_list, symbol_t fun_sym, bool left_binding)
// a + (b + c)
{
...
list_t read_freefix_args(any_t env, list_t parsetree, int narg)
{
